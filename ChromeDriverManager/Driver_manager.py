...
class DriverManager:
    ...
    """Manage downloads of chromedrivers for Windows machines
    ...
    def get_driver(self) -> str:
        ...
        """Get the desired driver and return path"""
        ...
        return f"{self.driver_folder}\\chromedriver-win32\\chromedriver.exe"
